...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <asp:GridView ID="gv_stationeries" runat="server" AutoGenerateColumns="False" >
        <Columns>
            <asp:HyperLinkField DataTextField="StationeryName" HeaderText="Stationery Name" DataNavigateUrlFields="StationeryID" DataNavigateUrlFormatString="StationeryDetails.aspx?ID={0}"/>
